...
// Update a report
async function updateReport(bearerToken, reportId, reportData) {
  try {
...
async function getReport(bearerToken, reportId) {
  try {
    // Validate reportId format (should be MongoDB ObjectId)
    if (!reportId || !reportId.match(/^[0-9a-fA-F]{24}$/)) {
      throw new McpError(
...
async function getAllReports(bearerToken) {
  try {
...
async function createReport(bearerToken, reportData) {
  try {
...
async function getVulnerability(bearerToken, vulnerabilityId) {
  try {
...
async function updateVulnerability(bearerToken, vulnerabilityId, vulnerabilityData) {
  try {
    // Validate vulnerabilityId format (should be MongoDB ObjectId)
    if (!vulnerabilityId || !vulnerabilityId.match(/^[0-9a-fA-F]{24}$/)) {
      throw new McpError(
...
async function deleteVulnerability(bearerToken, vulnerabilityId) {
  try {
    // Validate vulnerabilityId format (should be MongoDB ObjectId)
    if (!vulnerabilityId || !vulnerabilityId.match(/^[0-9a-fA-F]{24}$/)) {
      throw new McpError(
...
async function getVulnerabilities(bearerToken, reportId) {
  try {
    // Validate reportId format (should be MongoDB ObjectId)
    if (!reportId || !reportId.match(/^[0-9a-fA-F]{24}$/)) {
      throw new McpError(
...
async function createVulnerabilities(bearerToken, reportId, vulnerabilities) {
  try {
    // Validate reportId format (should be MongoDB ObjectId)
    if (!reportId || !reportId.match(/^[0-9a-fA-F]{24}$/)) {
      throw new McpError(
    ...
    tools: [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          required: ['bearerToken', 'vulnerabilityId'],
        },
      },
      {
      ...
      },
      {
        ...
        inputSchema: {
          ...
          required: ['bearerToken', 'reportId', 'vulnerabilities'],
        },
      },
    ],
  };
